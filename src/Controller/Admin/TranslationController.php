...
class TranslationController extends Basecontroller
{
    ...
    public function overviewAction()
    {
        ...
        return $this->render('translation/Translation/overview.html.twig', array(
    ...
    public function gridAction()
    {
        ...
        return $this->render('translation/Translation/grid.html.twig', array(
            'layout'         => $this->container->getParameter('lexik_translation.base_layout'),
    ...
    public function newAction(Request $request)
    {
        ...
        if ($handler->process($form, $request)) {
            ...
            return $this->redirect($this->generateUrl($redirectUrl, $request->query->all()));
        }

        return $this->render('translation/Translation/new.html.twig', array(
            'layout' => $this->container->getParameter('lexik_translation.base_layout'),
